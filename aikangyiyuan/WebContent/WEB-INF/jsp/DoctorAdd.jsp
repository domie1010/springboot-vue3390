	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="doctor/informationAdd" method="POST"  enctype="multipart/form-data"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>医生姓名<b>*</b></label><input id="name" 
						...
						<li><label>医生年龄<b>*</b></label><input id="age" 
							name="age" type="text" class="dfinput" placeholder="请填写医生年龄"
							style="width: 518px;" /></li>
						<li><label>医生价格<b>*</b></label><input id="price" 
