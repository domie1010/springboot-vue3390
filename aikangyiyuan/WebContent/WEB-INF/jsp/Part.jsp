	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="part/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${part['id'] }">
					<ul class="forminfo">
						<li><label>科室名称<b>*</b></label><input id="name" value="${part['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写科室名称"
