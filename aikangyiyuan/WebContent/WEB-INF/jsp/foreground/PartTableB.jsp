...
<table width="100%" height="27" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td class="shopcarttitle">请选择科室</td>
  </tr>
</table>
<br>
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="shopcart">
		  <tr >
		    <td class="cap">&nbsp;</td> 
			<td class="cap">科室名称</td>
			<td class="cap">操作</td>
		  </tr>
		  <c:forEach items="${partList.datas }" var="part" varStatus="vs">
                <tr >
	                <td>&nbsp; </td>
	                <td><c:out value="${part['name'] }"/></td>
                <td>
                <a href="doctor/informationLoadFore?type=2&part_id=${part['id'] }">选择</a>
                </td>
                </tr>
 			 </c:forEach>
</table>
