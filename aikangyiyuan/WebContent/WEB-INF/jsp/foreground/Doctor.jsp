...
<div id="shopcontent">
<form method="post" id="doctor" action="bargain/informationAdd" onsubmit="return check();">
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="piczone">
				...
				<td align="center">
				<div id="shopview">
					<img src="upload/upload/${doctor['url'] }" style="width: 174px;height: 241px;" border="0" id="shoploading" class="shoploading">
				</div>
				</td>
				</tr>
				</table>
          ...
          <td>
		  <div id="prodtitle">${doctor['name'] } </div>
			<div id="prop">
				所属诊室：${doctor['part']['name'] }<br />
				性别：
			...
			诊费：<span class="price">￥${doctor['price'] }</span><br />
			</div>
	...
	<div id="switch_body" class="bodyzone_cap_now">医生介绍</div>
