...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="shopcart">
		  <tr >
		    <td class="cap">&nbsp;</td> 
			<td class="cap">用户姓名</td>
			<td class="cap">医师姓名</td>
			<td class="cap">医师诊室</td>
			<td class="cap">医师价格</td>
		  ...
		  <c:forEach items="${pager.datas }" var="bargain" varStatus="vs">
                <tr >
	                ...
	                <td><c:out value="${bargain['userInfo']['userName'] }"></c:out></td>
							<td><c:out value="${bargain['doctor']['name'] }"></c:out></td>
							<td><c:out value="${bargain['doctor']['part']['name'] }"></c:out></td>
							<td><c:out value="${bargain['doctor']['price'] }"></c:out></td>
                ...
                <a href="bargain/getTicket?id=${bargain['id'] }&flag=1">付款</a>
                <a href="bargain/backTicket?id=${bargain['id'] }&flag=2">取消</a>
                </c:if>
                <c:if test="${!t1 }">
                		<a href="doctor/informationLoadOneFore?id=${bargain['doctor']['id'] }">再次预订</a>
                		<a href="request/messageAddFore?bargain_id=${bargain['id'] }">留言</a>
                </c:if>
                </td>
                </tr>
 			 </c:forEach>
